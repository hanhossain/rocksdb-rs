...
using rocksdb::FileSystem;
using rocksdb::ImmutableCFOptions;
using rocksdb::ImmutableOptions;
using rocksdb::InternalIterator;
using rocksdb::IOOptions;
using rocksdb::kMaxSequenceNumber;
using rocksdb::Options;
using rocksdb::ParsedInternalKey;
using rocksdb::ParseInternalKey;
...
TableReader* NewTableReader(const std::string& sst_file_path,
  ...
  rocksdb_rs::status::Status s =
      options.env->GetFileSize(sst_file_path, &file_size);
  if (s.ok()) {
