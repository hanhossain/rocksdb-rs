...
std::map<std::tuple<BackgroundErrorReason, Status::Code, SubCode, bool>,
         Severity>
    ErrorSeverityMap = {
        // Errors during BG compaction
        {std::make_tuple(BackgroundErrorReason::kCompaction,
                         Status::Code::kIOError, SubCode::kNoSpace,
                         true),
         Severity::kSoftError},
        {std::make_tuple(BackgroundErrorReason::kCompaction,
                         Status::Code::kIOError, SubCode::kNoSpace,
         ...
         Severity::kNoError},
        {std::make_tuple(BackgroundErrorReason::kCompaction,
                         Status::Code::kIOError, SubCode::kSpaceLimit,
                         true),
         Severity::kHardError},
        {std::make_tuple(BackgroundErrorReason::kCompaction,
                         Status::Code::kIOError, SubCode::kIOFenced,
                         true),
