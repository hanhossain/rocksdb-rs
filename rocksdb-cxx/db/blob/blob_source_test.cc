...
TEST_F(BlobSourceTest, MultiGetBlobsFromMultiFiles) {
...

  {
    ...
    rust::Vec<rocksdb_rs::status::Status> statuses_buf = Status_new().create_vec(num_blobs * blob_files);
    ...
    rust::Vec<rocksdb_rs::status::Status> fake_statuses_buf = Status_new().create_vec(num_blobs);
