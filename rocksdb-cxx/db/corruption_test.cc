 ...
 public:
  ...
  virtual rocksdb_rs::io_status::IOStatus NewWritableFile(const std::string& fname,
    ...
    if (writable_file_error_) {
      ...
      return rocksdb_rs::io_status::IOStatus_IOError(fname, "fake error");
    }
...
TEST_F(CorruptionTest, PostPITRCorruptionWALsRetained) {
  ...
  CorruptFileWithTruncation(rocksdb_rs::types::FileType::kWalFile, log_num,
                            /*bytes_to_truncate=*/1);
...
TEST_F(CorruptionTest, TableFile) {
  ...
  Corrupt(rocksdb_rs::types::FileType::kTableFile, 100, 1);
  Check(99, 99);
...
TEST_F(CorruptionTest, TableFileIndexData) {
  ...
  Corrupt(rocksdb_rs::types::FileType::kTableFile, -2000, 500);
...
TEST_F(CorruptionTest, VerifyWholeTableChecksum) {
  ...
  Corrupt(rocksdb_rs::types::FileType::kTableFile, 0, 1);
