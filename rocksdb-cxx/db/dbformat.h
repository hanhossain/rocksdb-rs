...
class IterKey {
 public:
  ...
  void EncodeLengthPrefixedKey(const Slice& key) {
    auto size = key.size();
    EnlargeBufferIfNeeded(size + static_cast<size_t>(rocksdb_rs::coding::VarintLength(size)));
    char* ptr = rocksdb_rs::coding::EncodeVarint32(buf_, static_cast<uint32_t>(size));
