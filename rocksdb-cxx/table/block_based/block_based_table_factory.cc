    ...
    block_based_table_type_info = {
        ...
        {"checksum",
         {offsetof(struct BlockBasedTableOptions, checksum),
          rocksdb_rs::utilities::options_type::OptionType::kChecksumType, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"no_block_cache",
        ...
        {"block_cache_compressed",
         {0, rocksdb_rs::utilities::options_type::OptionType::kUnknown, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kNone}},
