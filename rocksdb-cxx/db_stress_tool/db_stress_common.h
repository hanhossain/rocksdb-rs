...
extern enum rocksdb_rs::compression_type::CompressionType
...
namespace rocksdb {
inline enum rocksdb_rs::compression_type::CompressionType
StringToCompressionType(const char* ctype) {
  ...
  if (!strcasecmp(ctype, "disable")) {
    ret_compression_type = rocksdb_rs::compression_type::CompressionType::
    ...
    ret_compression_type = rocksdb_rs::compression_type::CompressionType::
        kSnappyCompression;  // default value
  }
  if (ret_compression_type != rocksdb_rs::compression_type::CompressionType::
                                  kDisableCompressionOption &&
