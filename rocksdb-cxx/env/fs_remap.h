...
class RemapFileSystem : public FileSystemWrapper {
 ...
 protected:
  ...
  virtual std::pair<rocksdb_rs::io_status::IOStatus, std::string> EncodePathWithNewBasename(
 ...
 public:
  ...
  rocksdb_rs::io_status::IOStatus NewDirectory(const std::string& dir, const IOOptions& options,
