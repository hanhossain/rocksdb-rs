...
class UnregisteredTableFactory : public TableFactory {
 public:
  ...
  rocksdb_rs::status::Status NewTableReader(
      const ReadOptions&, const TableReaderOptions&,
...
TEST_F(OptionsTest, GetOptionsFromMapTest) {
  ...
  ASSERT_EQ(new_cf_opt.bottommost_compression,
            rocksdb_rs::compression_type::CompressionType::kLZ4Compression);
  ...
  ASSERT_EQ(new_cf_opt.blob_compression_type,
            rocksdb_rs::compression_type::CompressionType::kZSTD);
...
TEST_F(OptionsTest, OldInterfaceTest) {
  ...
  rocksdb_rs::status::Status s = GetDBOptionsFromMap(
      db_config_options, base_db_opt, db_options_map, &new_db_opt);
  ASSERT_NOK(s);
  ASSERT_TRUE(s.IsInvalidArgument());
...
TEST_F(OptionsTest, GetOptionsFromStringTest) {
  ...
  ASSERT_EQ(
      new_options.bottommost_compression,
  ...
  rocksdb_rs::status::Status s = GetOptionsFromString(
      config_options, base_options,
      "create_if_missing=XX;dump_malloc_stats=true", &bad_options);
  ASSERT_NOK(s);
  ASSERT_TRUE(s.IsInvalidArgument());
...
TEST_F(OptionsTest, GetStringFromCompressionType) {
  ...
  ASSERT_OK(GetStringFromCompressionType(
      &res, rocksdb_rs::compression_type::CompressionType::kNoCompression));
  ASSERT_EQ(res, "kNoCompression");

  ASSERT_OK(GetStringFromCompressionType(
      &res, rocksdb_rs::compression_type::CompressionType::kSnappyCompression));
  ASSERT_EQ(res, "kSnappyCompression");

  ASSERT_OK(GetStringFromCompressionType(
      &res, rocksdb_rs::compression_type::CompressionType::
                kDisableCompressionOption));
  ASSERT_EQ(res, "kDisableCompressionOption");

  ASSERT_OK(GetStringFromCompressionType(
      &res, rocksdb_rs::compression_type::CompressionType::kLZ4Compression));
  ASSERT_EQ(res, "kLZ4Compression");

  ASSERT_OK(GetStringFromCompressionType(
      &res, rocksdb_rs::compression_type::CompressionType::kZlibCompression));
  ASSERT_EQ(res, "kZlibCompression");

  ASSERT_NOK(GetStringFromCompressionType(
      &res, static_cast<rocksdb_rs::compression_type::CompressionType>(-10)));
}
...
class OptionsSanityCheckTest : public OptionsParserTest,
 ...
 protected:
  rocksdb_rs::status::Status SanityCheckOptions(
  ...
  rocksdb_rs::status::Status SanityCheckCFOptions(
      const ColumnFamilyOptions& cf_opts, ConfigOptions::SanityLevel level) {
  ...
  void SanityCheckCFOptions(const ColumnFamilyOptions& opts, bool exact) {
    ...
    ASSERT_OK(SanityCheckCFOptions(
        opts, ConfigOptions::SanityLevel::kSanityLevelNone));
    if (exact) {
      ASSERT_OK(SanityCheckCFOptions(
          opts, ConfigOptions::SanityLevel::kSanityLevelExactMatch));
    } else {
  ...
  rocksdb_rs::status::Status SanityCheckDBOptions(
      const DBOptions& db_opts, ConfigOptions::SanityLevel level) {
  ...
  void SanityCheckDBOptions(const DBOptions& opts, bool exact) {
    ...
    if (exact) {
      ...
      ASSERT_NOK(SanityCheckDBOptions(
          opts, ConfigOptions::SanityLevel::kSanityLevelExactMatch));
    }
  }

  rocksdb_rs::status::Status PersistOptions(
      const DBOptions& db_opts, const ColumnFamilyOptions& cf_opts) {
    rocksdb_rs::status::Status s =
        fs_->DeleteFile(kOptionsFileName, IOOptions(), nullptr).status();
    if (!s.ok()) {
      return s;
    }
  ...
  rocksdb_rs::status::Status PersistCFOptions(
...
TEST_P(OptionsSanityCheckTest, MergeOperatorErrorMessage) {
  ...
  rocksdb_rs::status::Status s = SanityCheckCFOptions(
      opts, ConfigOptions::SanityLevel::kSanityLevelLooselyCompatible);
  ASSERT_TRUE(s.IsInvalidArgument());
...
template <typename T>
void TestOptInfo(const ConfigOptions& config_options,
                 rocksdb_rs::utilities::options_type::OptionType opt_type,
                 T* base, T* comp) {
  std::string result;
...
TEST_F(OptionTypeInfoTest, BasicTypes) {
  ...
  {
    bool a = true, b = false;
    TestOptInfo(config_options,
                rocksdb_rs::utilities::options_type::OptionType::kBoolean, &a,
                &b);
  }
  {
    int a = 100, b = 200;
    TestOptInfo(config_options,
                rocksdb_rs::utilities::options_type::OptionType::kInt, &a, &b);
  }
  {
    int32_t a = 100, b = 200;
    TestOptInfo(config_options,
                rocksdb_rs::utilities::options_type::OptionType::kInt32T, &a,
                &b);
  }
  {
    int64_t a = 100, b = 200;
    TestOptInfo(config_options,
                rocksdb_rs::utilities::options_type::OptionType::kInt64T, &a,
                &b);
  }
  {
    unsigned int a = 100, b = 200;
    TestOptInfo(config_options,
                rocksdb_rs::utilities::options_type::OptionType::kUInt, &a, &b);
  }
  {
    uint32_t a = 100, b = 200;
    TestOptInfo(config_options,
                rocksdb_rs::utilities::options_type::OptionType::kUInt32T, &a,
                &b);
  }
  {
    uint64_t a = 100, b = 200;
    TestOptInfo(config_options,
                rocksdb_rs::utilities::options_type::OptionType::kUInt64T, &a,
                &b);
  }
  {
    size_t a = 100, b = 200;
    TestOptInfo(config_options,
                rocksdb_rs::utilities::options_type::OptionType::kSizeT, &a,
                &b);
  }
  {
    std::string a = "100", b = "200";
    TestOptInfo(config_options,
                rocksdb_rs::utilities::options_type::OptionType::kString, &a,
                &b);
  }
  {
    double a = 1.0, b = 2.0;
    TestOptInfo(config_options,
                rocksdb_rs::utilities::options_type::OptionType::kDouble, &a,
                &b);
  }
}
...
TEST_F(OptionTypeInfoTest, TestInvalidArgs) {
  ...
  ASSERT_NOK(OptionTypeInfo(
                 0, rocksdb_rs::utilities::options_type::OptionType::kBoolean)
                 .Parse(config_options, "b", "x", &b));
  ASSERT_NOK(
      OptionTypeInfo(0, rocksdb_rs::utilities::options_type::OptionType::kInt)
          .Parse(config_options, "b", "x", &i));
  ASSERT_NOK(OptionTypeInfo(
                 0, rocksdb_rs::utilities::options_type::OptionType::kInt32T)
                 .Parse(config_options, "b", "x", &i32));
  ASSERT_NOK(OptionTypeInfo(
                 0, rocksdb_rs::utilities::options_type::OptionType::kInt64T)
                 .Parse(config_options, "b", "x", &i64));
  ASSERT_NOK(
      OptionTypeInfo(0, rocksdb_rs::utilities::options_type::OptionType::kUInt)
          .Parse(config_options, "b", "x", &u));
  ASSERT_NOK(OptionTypeInfo(
                 0, rocksdb_rs::utilities::options_type::OptionType::kUInt32T)
                 .Parse(config_options, "b", "x", &u32));
  ASSERT_NOK(OptionTypeInfo(
                 0, rocksdb_rs::utilities::options_type::OptionType::kUInt64T)
                 .Parse(config_options, "b", "x", &u64));
  ASSERT_NOK(
      OptionTypeInfo(0, rocksdb_rs::utilities::options_type::OptionType::kSizeT)
          .Parse(config_options, "b", "x", &sz));
  ASSERT_NOK(OptionTypeInfo(
                 0, rocksdb_rs::utilities::options_type::OptionType::kDouble)
...
TEST_F(OptionTypeInfoTest, TestPrepareFunc) {
  OptionTypeInfo opt_info(
      ...
      rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal,
      rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone);
  opt_info.SetPrepareFunc([](const ConfigOptions& /*opts*/,
...
TEST_F(OptionTypeInfoTest, TestValidateFunc) {
  ...
  opt_info.SetValidateFunc([](const DBOptions& db_opts,
    ...
    if (is_valid) {
      ...
      return rocksdb_rs::status::Status_InvalidArgument("Mismatched value",
                                                        name);
    }
  });
  ConfigOptions config_options;
...
TEST_F(OptionTypeInfoTest, TestBuiltinEnum) {
  ...
  for (auto iter : OptionsHelper::compaction_style_string_map) {
    ...
    TestParseAndCompareOption(
        ...
        OptionTypeInfo(
            0,
            rocksdb_rs::utilities::options_type::OptionType::kCompactionStyle),
  ...
  for (auto iter : OptionsHelper::compaction_pri_string_map) {
    ...
    TestParseAndCompareOption(
        config_options,
        OptionTypeInfo(
            0, rocksdb_rs::utilities::options_type::OptionType::kCompactionPri),
  ...
  for (auto iter : OptionsHelper::compaction_stop_style_string_map) {
    ...
    TestParseAndCompareOption(
        config_options,
        OptionTypeInfo(0, rocksdb_rs::utilities::options_type::OptionType::
  ...
  for (auto iter : OptionsHelper::checksum_type_string_map) {
    ...
    TestParseAndCompareOption(
        config_options,
        OptionTypeInfo(
            0, rocksdb_rs::utilities::options_type::OptionType::kChecksumType),
  ...
  for (auto iter : OptionsHelper::encoding_type_string_map) {
    ...
    TestParseAndCompareOption(
        config_options,
        OptionTypeInfo(
            0, rocksdb_rs::utilities::options_type::OptionType::kEncodingType),
...
TEST_F(OptionTypeInfoTest, TestStaticType) {
  ...
  static std::unordered_map<std::string, OptionTypeInfo> type_map = {
      {"size",
       {offsetof(struct SimpleOptions, size),
        rocksdb_rs::utilities::options_type::OptionType::kSizeT}},
      {"verify",
       {offsetof(struct SimpleOptions, verify),
