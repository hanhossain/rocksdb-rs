    ...
    compression_options_type_info = {
        ...
        {"max_dict_buffer_bytes",
         {offsetof(struct CompressionOptions, max_dict_buffer_bytes),
          rocksdb_rs::utilities::options_type::OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
    ...
    file_temperature_age_type_info = {
        {"temperature",
         {offsetof(struct FileTemperatureAge, temperature),
          rocksdb_rs::utilities::options_type::OptionType::kTemperature, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"age",
    ...
    fifo_compaction_options_type_info = {
        ...
        {"age_for_warm",
         {offsetof(struct CompactionOptionsFIFO, age_for_warm),
          ...
          OptionTypeFlags::kMutable}},
        {"ttl",
         {0, rocksdb_rs::utilities::options_type::OptionType::kUInt64T, OptionVerificationType::kDeprecated,
    ...
    universal_compaction_options_type_info = {
        {"size_ratio",
         {offsetof(class CompactionOptionsUniversal, size_ratio),
          rocksdb_rs::utilities::options_type::OptionType::kUInt, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"min_merge_width",
        ...
        {"stop_style",
         {offsetof(class CompactionOptionsUniversal, stop_style),
          rocksdb_rs::utilities::options_type::OptionType::kCompactionStopStyle, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"incremental",
    ...
    cf_mutable_options_type_info = {
        ...
        {"disable_auto_compactions",
         {offsetof(struct MutableCFOptions, disable_auto_compactions),
          ...
          OptionTypeFlags::kMutable}},
        {"filter_deletes",
         {0, rocksdb_rs::utilities::options_type::OptionType::kBoolean, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kMutable}},
        ...
        {"hard_pending_compaction_bytes_limit",
         {offsetof(struct MutableCFOptions,
          ...
          OptionTypeFlags::kMutable}},
        {"hard_rate_limit",
         {0, rocksdb_rs::utilities::options_type::OptionType::kDouble, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kMutable}},
        {"soft_rate_limit",
         {0, rocksdb_rs::utilities::options_type::OptionType::kDouble, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kMutable}},
        ...
        {"expanded_compaction_factor",
         {0, rocksdb_rs::utilities::options_type::OptionType::kInt, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kMutable}},
        ...
        {"memtable_prefix_bloom_huge_page_tlb_size",
         {0, rocksdb_rs::utilities::options_type::OptionType::kSizeT, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kMutable}},
        {"write_buffer_size",
        ...
        {"memtable_prefix_bloom_bits",
         {0, rocksdb_rs::utilities::options_type::OptionType::kUInt32T, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kMutable}},
        {"memtable_prefix_bloom_size_ratio",
         {offsetof(struct MutableCFOptions, memtable_prefix_bloom_size_ratio),
          rocksdb_rs::utilities::options_type::OptionType::kDouble, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        ...
        {"compression",
         {offsetof(struct MutableCFOptions, compression),
          rocksdb_rs::utilities::options_type::OptionType::kCompressionType, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"prefix_extractor",
        ...
        {"bottommost_temperature",
         {0, rocksdb_rs::utilities::options_type::OptionType::kTemperature, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kMutable}},
        ...
        {"block_protection_bytes_per_key",
         {offsetof(struct MutableCFOptions, block_protection_bytes_per_key),
          rocksdb_rs::utilities::options_type::OptionType::kUInt8T, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {kOptNameCompOpts,
         OptionTypeInfo::Struct(
...
static std::unordered_map<std::string, OptionTypeInfo>
    cf_immutable_options_type_info = {
        ...
        {"max_write_buffer_size_to_maintain",
         {offsetof(struct ImmutableCFOptions,
                   max_write_buffer_size_to_maintain),
          rocksdb_rs::utilities::options_type::OptionType::kInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        ...
        {"rate_limit_delay_max_milliseconds",
         {0, rocksdb_rs::utilities::options_type::OptionType::kUInt, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kNone}},
        {"comparator",
        ...
        {"memtable_factory",
         {offsetof(struct ImmutableCFOptions, memtable_factory),
          rocksdb_rs::utilities::options_type::OptionType::kCustomizable, OptionVerificationType::kByName,
        ...
        {"memtable",
         {offsetof(struct ImmutableCFOptions, memtable_factory),
          rocksdb_rs::utilities::options_type::OptionType::kCustomizable, OptionVerificationType::kAlias,
          OptionTypeFlags::kShared,
          [](const ConfigOptions& opts, const std::string&,
             const std::string& value, void* addr) {
            std::unique_ptr<MemTableRepFactory> factory;
        ...
        {"compaction_style",
         {offsetof(struct ImmutableCFOptions, compaction_style),
          rocksdb_rs::utilities::options_type::OptionType::kCompactionStyle, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"compaction_pri",
         {offsetof(struct ImmutableCFOptions, compaction_pri),
          rocksdb_rs::utilities::options_type::OptionType::kCompactionPri, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
