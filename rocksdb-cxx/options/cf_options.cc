...
static rocksdb_rs::status::Status ParseCompressionOptions(
    ...
    file_temperature_age_type_info = {
        {"temperature",
         {offsetof(struct FileTemperatureAge, temperature),
          rocksdb_rs::utilities::options_type::OptionType::kTemperature,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kMutable}},
        {"age",
         {offsetof(struct FileTemperatureAge, age),
          rocksdb_rs::utilities::options_type::OptionType::kUInt64T,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kMutable}},
};
        ...
        {"file_temperature_age_thresholds",
         OptionTypeInfo::Vector<struct FileTemperatureAge>(
             ...
             OptionTypeInfo::Struct("file_temperature_age_thresholds",
                                    ...
                                    rocksdb_rs::utilities::options_type::
    ...
    universal_compaction_options_type_info = {
        {"size_ratio",
         {offsetof(class CompactionOptionsUniversal, size_ratio),
          rocksdb_rs::utilities::options_type::OptionType::kUInt,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kMutable}},
        {"min_merge_width",
        ...
        {"stop_style",
         {offsetof(class CompactionOptionsUniversal, stop_style),
          rocksdb_rs::utilities::options_type::OptionType::kCompactionStopStyle,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kMutable}},
        {"incremental",
...
static std::unordered_map<std::string, OptionTypeInfo>
    cf_mutable_options_type_info = {
        ...
        {"bottommost_temperature",
         {0, rocksdb_rs::utilities::options_type::OptionType::kTemperature,
          rocksdb_rs::utilities::options_type::OptionVerificationType::
              kDeprecated,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kMutable}},
        ...
        {"compression_per_level",
         OptionTypeInfo::Vector<rocksdb_rs::compression_type::CompressionType>(
             ...
             rocksdb_rs::utilities::options_type::OptionVerificationType::
                 kNormal,
             rocksdb_rs::utilities::options_type::OptionTypeFlags::kMutable,
             {0, rocksdb_rs::utilities::options_type::OptionType::
                     kCompressionType})},
...
static std::unordered_map<std::string, OptionTypeInfo>
    cf_immutable_options_type_info = {
        ...
        {"max_write_buffer_size_to_maintain",
         {offsetof(struct ImmutableCFOptions,
                   max_write_buffer_size_to_maintain),
          rocksdb_rs::utilities::options_type::OptionType::kInt64T,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"min_write_buffer_number_to_merge",
         {offsetof(struct ImmutableCFOptions, min_write_buffer_number_to_merge),
          ...
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone, 0}},
        {"num_levels",
         {offsetof(struct ImmutableCFOptions, num_levels),
          rocksdb_rs::utilities::options_type::OptionType::kInt,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"bloom_locality",
        ...
        {"rate_limit_delay_max_milliseconds",
         {0, rocksdb_rs::utilities::options_type::OptionType::kUInt,
          rocksdb_rs::utilities::options_type::OptionVerificationType::
              kDeprecated,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"comparator",
         ...
         {offsetof(struct ImmutableCFOptions, table_factory),
          ...
          [](const ConfigOptions& opts, const std::string& name,
            ...
            if (name == "block_based_table_factory") {
              ...
              rocksdb_rs::status::Status s =
                  new_factory->ConfigureFromString(opts, value);
              if (s.ok()) {
        ...
        {"compaction_pri",
         {offsetof(struct ImmutableCFOptions, compaction_pri),
          rocksdb_rs::utilities::options_type::OptionType::kCompactionPri,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
...
class ConfigurableCFOptions : public ConfigurableMutableCFOptions {
 ...
 protected:
  rocksdb_rs::status::Status ConfigureOptions(
    ...
    rocksdb_rs::status::Status s =
        Configurable::ConfigureOptions(config_options, opts_map, unused);
    if (s.ok()) {
