    ...
    cf_immutable_options_type_info = {
        ...
        {"comparator",
         OptionTypeInfo::AsCustomRawPtr<const Comparator>(
             ...
             rocksdb_rs::utilities::options_type::OptionVerificationType::kByName, OptionTypeFlags::kCompareLoose)
             .SetSerializeFunc(
        ...
        {"memtable_insert_with_hint_prefix_extractor",
         OptionTypeInfo::AsCustomSharedPtr<const SliceTransform>(
             offsetof(struct ImmutableCFOptions,
                      memtable_insert_with_hint_prefix_extractor),
             rocksdb_rs::utilities::options_type::OptionVerificationType::kByNameAllowNull, OptionTypeFlags::kNone)},
        {"memtable_factory",
        ...
        {"table_properties_collectors",
         OptionTypeInfo::Vector<
             ...
             rocksdb_rs::utilities::options_type::OptionVerificationType::kByName, OptionTypeFlags::kNone,
        ...
        {"compaction_filter",
         OptionTypeInfo::AsCustomRawPtr<const CompactionFilter>(
             ...
             rocksdb_rs::utilities::options_type::OptionVerificationType::kByName, OptionTypeFlags::kAllowNull)},
