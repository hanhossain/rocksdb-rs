    ...
    db_mutable_options_type_info = {
        ...
        {"stats_history_buffer_size",
         {offsetof(struct MutableDBOptions, stats_history_buffer_size),
          ...
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kMutable}},
        {"max_open_files",
         {offsetof(struct MutableDBOptions, max_open_files), rocksdb_rs::utilities::options_type::OptionType::kInt,
    ...
    db_immutable_options_type_info = {
        ...
        {"use_direct_io_for_flush_and_compaction",
         {offsetof(struct ImmutableDBOptions,
          ...
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"allow_2pc",
         {offsetof(struct ImmutableDBOptions, allow_2pc), rocksdb_rs::utilities::options_type::OptionType::kBoolean,
        ...
        {"experimental_mempurge_policy",
         {0, rocksdb_rs::utilities::options_type::OptionType::kString, rocksdb_rs::utilities::options_type::OptionVerificationType::kDeprecated,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        ...
        {"use_adaptive_mutex",
         {offsetof(struct ImmutableDBOptions, use_adaptive_mutex),
          ...
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"use_fsync",
         {offsetof(struct ImmutableDBOptions, use_fsync), rocksdb_rs::utilities::options_type::OptionType::kBoolean,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal, rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        ...
        {"max_log_file_size",
         {offsetof(struct ImmutableDBOptions, max_log_file_size),
          ...
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"db_log_dir",
         {offsetof(struct ImmutableDBOptions, db_log_dir), rocksdb_rs::utilities::options_type::OptionType::kString,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal, rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"wal_dir",
         {offsetof(struct ImmutableDBOptions, wal_dir), rocksdb_rs::utilities::options_type::OptionType::kString,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal, rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"WAL_size_limit_MB",
        ...
        {"bgerror_resume_retry_interval",
         {offsetof(struct ImmutableDBOptions, bgerror_resume_retry_interval),
          ...
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"db_host_id",
         {offsetof(struct ImmutableDBOptions, db_host_id), rocksdb_rs::utilities::options_type::OptionType::kString,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal, rocksdb_rs::utilities::options_type::OptionTypeFlags::kCompareNever}},
        // Temporarily deprecated due to race conditions (examples in PR 10375).
        {"rate_limiter",
         {offsetof(struct ImmutableDBOptions, rate_limiter),
          rocksdb_rs::utilities::options_type::OptionType::kUnknown, rocksdb_rs::utilities::options_type::OptionVerificationType::kDeprecated,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kDontSerialize | rocksdb_rs::utilities::options_type::OptionTypeFlags::kCompareNever}},
        ...
        {"env",  //**TODO: Should this be kCustomizable?
         OptionTypeInfo(
             offsetof(struct ImmutableDBOptions, env), rocksdb_rs::utilities::options_type::OptionType::kUnknown,
        ...
        {"listeners",
         {offsetof(struct ImmutableDBOptions, listeners), rocksdb_rs::utilities::options_type::OptionType::kVector,
        ...
        {"lowest_used_cache_tier",
         OptionTypeInfo::Enum<CacheTier>(
             ...
             &cache_tier_string_map, rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone)},
