    ...
    db_immutable_options_type_info = {
        ...
        {"use_direct_io_for_flush_and_compaction",
         {offsetof(struct ImmutableDBOptions,
          ...
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"allow_2pc",
         {offsetof(struct ImmutableDBOptions, allow_2pc),
          rocksdb_rs::utilities::options_type::OptionType::kBoolean,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"wal_filter",
        ...
        {"use_adaptive_mutex",
         {offsetof(struct ImmutableDBOptions, use_adaptive_mutex),
          ...
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"use_fsync",
         {offsetof(struct ImmutableDBOptions, use_fsync),
          rocksdb_rs::utilities::options_type::OptionType::kBoolean,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        ...
        {"max_log_file_size",
         {offsetof(struct ImmutableDBOptions, max_log_file_size),
          ...
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"db_log_dir",
         {offsetof(struct ImmutableDBOptions, db_log_dir),
          rocksdb_rs::utilities::options_type::OptionType::kString,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"wal_dir",
         {offsetof(struct ImmutableDBOptions, wal_dir),
          rocksdb_rs::utilities::options_type::OptionType::kString,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"WAL_size_limit_MB",
        ...
        {"bgerror_resume_retry_interval",
         {offsetof(struct ImmutableDBOptions, bgerror_resume_retry_interval),
          ...
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kNone}},
        {"db_host_id",
         {offsetof(struct ImmutableDBOptions, db_host_id),
          rocksdb_rs::utilities::options_type::OptionType::kString,
          rocksdb_rs::utilities::options_type::OptionVerificationType::kNormal,
         ...
         OptionTypeInfo(
             ...
             .SetParseFunc([](const ConfigOptions& opts,
               ...
               rocksdb_rs::status::Status s =
                   Env::CreateFromString(opts, value,
        ...
        {"file_checksum_gen_factory",
         OptionTypeInfo::AsCustomSharedPtr<FileChecksumGenFactory>(
             ...
             rocksdb_rs::utilities::options_type::OptionTypeFlags::kAllowNull)},
        {"statistics", OptionTypeInfo::AsCustomSharedPtr<Statistics>(
                           // Statistics should not be compared and can be null
                           // Statistics are maked "don't serialize" until they
                           // can be shared between DBs
        ...
        {"listeners",
         {offsetof(struct ImmutableDBOptions, listeners),
          rocksdb_rs::utilities::options_type::OptionType::kVector,
          rocksdb_rs::utilities::options_type::OptionVerificationType::
              kByNameAllowNull,
          rocksdb_rs::utilities::options_type::OptionTypeFlags::kCompareNever,
          [](const ConfigOptions& opts, const std::string& /*name*/,
