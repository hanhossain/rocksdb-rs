...
static std::unordered_map<std::string, OptionTypeInfo>
    db_immutable_options_type_info = {
        ...
        {"experimental_mempurge_policy",
         {0, rocksdb_rs::utilities::options_type::OptionType::kString, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kNone}},
        ...
        {"rate_limiter",
         {offsetof(struct ImmutableDBOptions, rate_limiter),
          rocksdb_rs::utilities::options_type::OptionType::kUnknown, OptionVerificationType::kDeprecated,
        ...
        {"rate_limiter_bytes_per_sec",
         {offsetof(struct ImmutableDBOptions, rate_limiter),
          rocksdb_rs::utilities::options_type::OptionType::kUnknown, OptionVerificationType::kNormal,
          (OptionTypeFlags::kDontSerialize | OptionTypeFlags::kCompareNever),
