...
rocksdb_rs::io_status::IOStatus TimedFileSystem::NewSequentialFile(
...
rocksdb_rs::io_status::IOStatus TimedFileSystem::NewRandomAccessFile(
    const std::string& fname, const FileOptions& options,
...
rocksdb_rs::io_status::IOStatus TimedFileSystem::NewWritableFile(
    const std::string& fname, const FileOptions& options,
...
rocksdb_rs::io_status::IOStatus TimedFileSystem::ReuseWritableFile(
...
rocksdb_rs::io_status::IOStatus TimedFileSystem::NewRandomRWFile(
    const std::string& fname, const FileOptions& options,
...
rocksdb_rs::io_status::IOStatus TimedFileSystem::GetChildrenFileAttributes(
    const std::string& dir, const IOOptions& options,
