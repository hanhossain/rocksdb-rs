...
rocksdb_rs::status::Status OpenDb(const Options& options,
...
rocksdb_rs::status::Status CompactToLevel(const Options& options,
                                          const std::string& dbname,
...
rocksdb_rs::status::Status MigrateToUniversal(std::string dbname,
...
rocksdb_rs::status::Status MigrateToLevelBase(std::string dbname,
                                              const Options& old_opts,
                                              const Options& new_opts) {
